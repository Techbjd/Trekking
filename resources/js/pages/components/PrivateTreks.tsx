...
const cards = [
  { icon: MapPin, title: 'Personalized Itineraries', desc: 'Tailor your trek to fit your schedule and preferences.' },
  { icon: UserCheck, title: 'Dedicated Guide & Porter', desc: 'Experience expert guidance with personalized attention.' },
  { icon: Heart, title: 'Safety & Health Benefits', desc: 'Custom acclimatization and emergency support.' },
  { icon: Calendar, title: 'Flexible Schedule', desc: 'Trek at your pace without the pressure of a group.' },
  { icon: Shield, title: 'Privacy & Comfort', desc: 'Perfect for couples, families, and small groups.' },
];

const desktopPositions = [
  { left: 'left-[416px]', top: 'top-[212px]' },
  { left: 'left-[626px]', top: 'top-[212px]' },
  { left: 'left-[833px]', top: 'top-[212px]' },
  { left: 'left-[416px]', top: 'top-[359px]' },
  { left: 'left-[626px]', top: 'top-[359px]' },
  { left: 'left-[833px]', top: 'top-[359px]' },
];
    ...
    <section className="bg-[#F3F4F6]">
      ...
      <div className="hidden lg:block relative w-360 h-158.5 mx-auto">
        ...
        {cards.map((card, i) => (
          <div
            key={i}
            className={`absolute bg-[#F9FAFB] rounded-[10px] w-48.75 h-33 ${desktopPositions[i].left} ${desktopPositions[i].top} shadow-[0px_4px_4px_rgba(0,0,0,0.25)]`}
          >
